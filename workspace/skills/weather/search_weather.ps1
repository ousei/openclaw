# Weather Search Script using SearXNG - Extracts results from HTML
# Usage: .\search_weather.ps1 -weatherLocation "Tokyo"
# Or: .\search_weather.ps1 "Tokyo"
# Returns: JSON formatted search results from SearXNG HTML page
...
try {
    # Fetch HTML page using curl (more reliable)
