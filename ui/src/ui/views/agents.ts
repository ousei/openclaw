    ...
    <div class="agents-layout">
      <section class="card agents-sidebar">
        <div class="row" style="justify-content: space-between;">
          <div>
            <div class="card-title">${t("agents.cardTitle")}</div>
      ...
      <section class="agents-main">
        ${
          !selectedAgent
            ? html`
                <div class="card">
                  <div class="card-title">${t("agents.selectAgentPrompt")}</div>
...
function renderAgentHeader(
  ...
  const subtitle = agent.identity?.theme?.trim() || t("agents.agentWorkspace");
...
function renderAgentOverview(params: {
  ...
  return html`
    <section class="card">
      <div class="card-title">${t("agents.overview")}</div>
      ...
      <div class="agents-overview-grid" style="margin-top: 16px;">
        ...
        <div class="agent-kv">
          ...
          <div>${skillFilter ? `${skillCount} selected` : t("agents.allSkills")}</div>
        </div>
      </div>
      ...
      <div class="agent-model-select" style="margin-top: 20px;">
        ...
        <div class="row" style="gap: 12px; flex-wrap: wrap;">
          <label class="field" style="min-width: 260px; flex: 1;">
            <span>${isDefault ? t("agents.primaryModelDefault") : t("agents.primaryModel")}</span>
            <select
            ...
            >
              ${
                isDefault
                  ...
                  : html`
                      <option value="">
                        ${defaultPrimary ? t("agents.inheritDefaultWith", { value: defaultPrimary }) : t("agents.inheritDefault")}
                      </option>
                    `
              }
        ...
        <div class="row" style="justify-content: flex-end; gap: 8px;">
          ...
          <button
            ...
            @click=${onConfigSave}
          >
            ${configSaving ? t("cron.saving") : t("agents.save")}
          </button>
        </div>
      </div>
    </section>
