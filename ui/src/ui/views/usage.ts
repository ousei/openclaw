...
export function renderUsage(props: UsageProps) {
        ...
        <div class="row" style="justify-content: space-between; align-items: flex-start; flex-wrap: wrap; gap: 12px;">
          <div style="flex: 1; min-width: 250px;">
            <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 2px;">
              <div class="card-title" style="margin: 0;">${t("usage.tokenUsage")}</div>
              <span style="
                display: inline-flex;
                align-items: center;
                gap: 6px;
        ...
        <summary>
          ...
          ${
            selectedCount > 0
              ...
              : html`
                  <span class="usage-filter-badge">${t("usage.all")}</span>
                `
          }
        </summary>
  ...
  return html`
    ...
    <section class="usage-page-header">
      ...
      <div class="usage-page-subtitle">${t("usage.subtitle")}</div>
    </section>

    <section class="card usage-header ${props.headerPinned ? "pinned" : ""}">
      <div class="usage-header-row">
        <div class="usage-header-title">
          <div class="card-title" style="margin: 0;">${t("usage.filters")}</div>
          ${
            props.loading
              ? html`
                  <span class="usage-refresh-indicator">${t("common.loading")}</span>
                `
              : nothing
          }
          ${
            isEmpty
              ? html`
                  <span class="usage-query-hint">${t("usage.selectDateHint")}</span>
                `
              : nothing
          }
        </div>
      ...
      <div class="usage-header-row">
        <div class="usage-controls">
          ...
          />
          <span style="color: var(--muted);">${t("usage.to")}</span>
          <input
            type="date"
            .value=${props.endDate}
          ...
          >
            <option value="local">${t("usage.local")}</option>
            <option value="utc">${t("usage.utc")}</option>
          </select>
      ...
      <div style="margin-top: 12px;">
          ...
          <input
            ...
            placeholder=${t("usage.filterSessionsPlaceholder")}
          ...
          <div class="usage-query-actions">
            ...
            <span class="usage-query-hint">
              ${
                hasQuery
                  ? t("usage.sessionsMatch", { count: String(filteredSessions.length), total: String(totalSessions) })
                  : t("usage.sessionsInRange", { total: String(totalSessions) })
              }
            </span>
          </div>
        </div>
